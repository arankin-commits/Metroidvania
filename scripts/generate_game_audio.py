...
effect("fast_travel_select.wav", 420.0, 760.0, 0.22, 0.04)
effect("fast_travel_confirm.wav", 300.0, 920.0, 0.48, 0.08)
effect("hand_mount.wav", 190.0, 450.0, 0.36, 0.08)
effect("hand_dismount.wav", 480.0, 160.0, 0.32, 0.10)
