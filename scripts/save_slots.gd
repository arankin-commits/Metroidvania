...
static func load_slot(slot: int, root: String = "user://") -> Dictionary:
	...
	return {
		...
		"bow_hand_activated": bool(config.get_value("save", "bow_hand_activated", false)),
		"forest_hand_activated": bool(config.get_value("save", "forest_hand_activated", false)),
		...
		"cave_shortcut_open": bool(config.get_value("save", "cave_shortcut_open", false)),
		"gallery_cache_found": bool(config.get_value("save", "gallery_cache_found", false)),
...
static func new_slot() -> Dictionary:
	return {
		...
		"bow_hand_activated": false,
		"forest_hand_activated": false,
		"wall_broken": false,
		"secret_found": false,
		"note_found": false,
		"cave_shortcut_open": false,
		"gallery_cache_found": false,
